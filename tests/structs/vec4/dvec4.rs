...
fn test_mul() {
  ...
  assert_eq!(
    DVec4::new((2.0, 2.0, 1.0, 0.0)) * DVec4::new((0.0, 0.0, 0.0, 0.0)),
    DVec4::new((0.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 0.0)) * DVec4::new((0.0, 0.0, 0.0, 0.0)),
    DVec4::new((0.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 1.0)) * DVec4::new((0.0, 0.0, 0.0, 0.0)),
    DVec4::new((0.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((0.0, 0.0, 0.0, 0.0)),
    DVec4::new((0.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((1.0, 0.0, 0.0, 0.0)),
    DVec4::new((2.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((2.0, 0.0, 0.0, 0.0)),
    DVec4::new((4.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((2.0, 1.0, 0.0, 0.0)),
    DVec4::new((4.0, 2.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((2.0, 2.0, 0.0, 0.0)),
    DVec4::new((4.0, 4.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((2.0, 2.0, 1.0, 0.0)),
    DVec4::new((4.0, 4.0, 2.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) * DVec4::new((2.0, 2.0, 2.0, 0.0)),
...
fn test_mul_assign() {
  let mut vec = DVec4::new((1.0, 1.0, 1.0, 1.0));
  vec *= DVec4::new((1.0, 1.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((1.0, 1.0, 1.0, 1.0)));
  vec *= DVec4::new((2.0, 1.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((2.0, 1.0, 1.0, 1.0)));
  vec *= DVec4::new((3.0, 1.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((6.0, 1.0, 1.0, 1.0)));
  vec *= DVec4::new((3.0, 2.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((18.0, 2.0, 1.0, 1.0)));
  vec *= DVec4::new((3.0, 3.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((54.0, 6.0, 1.0, 1.0)));
  vec *= DVec4::new((3.0, 3.0, 2.0, 1.0));
  assert_eq!(vec, DVec4::new((162.0, 18.0, 2.0, 1.0)));
  vec *= DVec4::new((3.0, 3.0, 3.0, 1.0));
  assert_eq!(vec, DVec4::new((486.0, 54.0, 6.0, 1.0)));
  vec *= DVec4::new((3.0, 3.0, 3.0, 2.0));
  assert_eq!(vec, DVec4::new((1458.0, 162.0, 18.0, 2.0)));
  vec *= DVec4::new((3.0, 3.0, 3.0, 3.0));
  assert_eq!(vec, DVec4::new((4374.0, 486.0, 54.0, 6.0)));
}
...
fn test_div() {
  assert_eq!(
    DVec4::new((0.0, 0.0, 0.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((0.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((1.0, 0.0, 0.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((1.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 0.0, 0.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 0.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 1.0, 0.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 1.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 0.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 2.0, 0.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 1.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 2.0, 1.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 2.0, 2.0, 0.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 0.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
  ...
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 1.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 2.0, 2.0, 1.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((1.0, 1.0, 1.0, 1.0)),
    DVec4::new((2.0, 2.0, 2.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((2.0, 1.0, 1.0, 1.0)),
    DVec4::new((1.0, 2.0, 2.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 1.0, 1.0, 1.0)),
    DVec4::new((0.5, 2.0, 2.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 2.0, 1.0, 1.0)),
    DVec4::new((0.5, 1.0, 2.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 4.0, 1.0, 1.0)),
    DVec4::new((0.5, 0.5, 2.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 4.0, 2.0, 1.0)),
    DVec4::new((0.5, 0.5, 1.0, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 4.0, 4.0, 1.0)),
    DVec4::new((0.5, 0.5, 0.5, 2.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 4.0, 4.0, 2.0)),
    DVec4::new((0.5, 0.5, 0.5, 1.0))
  );
  assert_eq!(
    DVec4::new((2.0, 2.0, 2.0, 2.0)) / DVec4::new((4.0, 4.0, 4.0, 4.0)),
    DVec4::new((0.5, 0.5, 0.5, 0.5))
  );
}
...
fn test_div_assign() {
  ...
  assert_eq!(vec, DVec4::new((1.0, 1.0, 1.0, 1.0)));
  vec /= DVec4::new((2.0, 1.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((0.5, 1.0, 1.0, 1.0)));
  vec /= DVec4::new((5.0, 1.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((0.1, 1.0, 1.0, 1.0)));
  vec /= DVec4::new((5.0, 2.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((0.02, 0.5, 1.0, 1.0)));
  vec /= DVec4::new((5.0, 5.0, 1.0, 1.0));
  assert_eq!(vec, DVec4::new((0.004, 0.1, 1.0, 1.0)));
  vec /= DVec4::new((5.0, 5.0, 2.0, 1.0));
  assert_eq!(vec, DVec4::new((0.0008, 0.02, 0.5, 1.0)));
  vec /= DVec4::new((5.0, 5.0, 5.0, 1.0));
  assert_eq!(vec, DVec4::new((0.00016, 0.004, 0.1, 1.0)));
  vec /= DVec4::new((5.0, 5.0, 5.0, 2.0));
  assert_eq!(vec, DVec4::new((3.2000000000000005e-5, 0.0008, 0.02, 0.5)));
  vec /= DVec4::new((5.0, 5.0, 5.0, 5.0));
  assert_eq!(vec, DVec4::new((6.400000000000001e-6, 0.00016, 0.004, 0.1)));
}
