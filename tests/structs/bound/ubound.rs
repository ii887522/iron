...
#[test]
fn test_clamp() {
  assert_eq!(UBound::new((0, 0)).clamp(0), 0);
  assert_eq!(UBound::new((0, 1)).clamp(0), 0);
  assert_eq!(UBound::new((0, 2)).clamp(0), 0);
  assert_eq!(UBound::new((1, 2)).clamp(0), 1);
  assert_eq!(UBound::new((2, 2)).clamp(0), 2);
  assert_eq!(UBound::new((2, 3)).clamp(0), 2);
  assert_eq!(UBound::new((2, 4)).clamp(0), 2);
  assert_eq!(UBound::new((2, 4)).clamp(1), 2);
  assert_eq!(UBound::new((2, 4)).clamp(2), 2);
  assert_eq!(UBound::new((2, 4)).clamp(3), 3);
  assert_eq!(UBound::new((2, 4)).clamp(4), 4);
  assert_eq!(UBound::new((2, 4)).clamp(5), 4);
  assert_eq!(UBound::new((2, 4)).clamp(6), 4);
}
