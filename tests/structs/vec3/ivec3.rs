...
fn test_mul_assign() {
  ...
  vec *= IVec3::new((3, 1, 1));
  assert_eq!(vec, IVec3::new((6, 1, 1)));
  vec *= IVec3::new((3, 2, 1));
  assert_eq!(vec, IVec3::new((18, 2, 1)));
  vec *= IVec3::new((3, 3, 1));
  assert_eq!(vec, IVec3::new((54, 6, 1)));
  vec *= IVec3::new((3, 3, 2));
  assert_eq!(vec, IVec3::new((162, 18, 2)));
  vec *= IVec3::new((3, 3, 3));
  assert_eq!(vec, IVec3::new((486, 54, 6)));
}
...
fn test_div() {
  assert_eq!(
    IVec3::new((0, 0, 0)) / IVec3::new((1, 1, 1)),
    IVec3::new((0, 0, 0))
  );
  assert_eq!(
    IVec3::new((1, 0, 0)) / IVec3::new((1, 1, 1)),
    IVec3::new((1, 0, 0))
  );
  assert_eq!(
    IVec3::new((2, 0, 0)) / IVec3::new((1, 1, 1)),
    IVec3::new((2, 0, 0))
  );
  assert_eq!(
    IVec3::new((2, 1, 0)) / IVec3::new((1, 1, 1)),
    IVec3::new((2, 1, 0))
  );
  assert_eq!(
    IVec3::new((2, 2, 0)) / IVec3::new((1, 1, 1)),
    IVec3::new((2, 2, 0))
  );
  assert_eq!(
    IVec3::new((2, 2, 1)) / IVec3::new((1, 1, 1)),
    IVec3::new((2, 2, 1))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((1, 1, 1)),
    IVec3::new((2, 2, 2))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((2, 1, 1)),
    IVec3::new((1, 2, 2))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((4, 1, 1)),
    IVec3::new((0, 2, 2))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((4, 2, 1)),
    IVec3::new((0, 1, 2))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((4, 4, 1)),
    IVec3::new((0, 0, 2))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((4, 4, 2)),
    IVec3::new((0, 0, 1))
  );
  assert_eq!(
    IVec3::new((2, 2, 2)) / IVec3::new((4, 4, 4)),
    IVec3::new((0, 0, 0))
  );
}
