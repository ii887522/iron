use crate::{math::ApproxEq, I32Vec4};
...
impl MulAssign<f64> for F64Vec4 {
...
impl DivAssign<f64> for F64Vec4 {
...
impl From<I32Vec4> for F64Vec4 {
  fn from(vec: I32Vec4) -> Self {
    Self::new((
      vec.get_x() as _,
      vec.get_y() as _,
      vec.get_z() as _,
